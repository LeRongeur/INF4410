...
1- Ouvrir les registre rmi sur les ports de votre choix (un port entre 5000 et 5050 différent pour chaque serveur) avec la commande rmiregistry dans le dossier bin
2- Lancer les serveurs (Calculator) avec en paramètres son port respectif, son q et son m (facultatif pour le mode sécurisé).
...
*La seule réelle différente est dans l'étape 2 où il faut s'assurer de bien rajouter le paramètre m*
1- Si ce n'est pas déjà fait, ouvrir les registre rmi sur les ports de votre choix (un port entre 5000 et 5050 différent pour chaque serveur) avec la commande rmiregistry dans le dossier bin
